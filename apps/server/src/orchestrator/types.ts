...
export interface Orchestrator {
  ...
  /** Switch the session's model (live), sub-agent model, effort and/or language (next turn). */
  setConfig(
    sessionId: string,
    model?: string,
    effort?: string,
  ...
  /**
   * The given Claude seat hit its usage limit — record it, pick the next usable
